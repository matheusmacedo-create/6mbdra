...
2. **Tamanho por arquivo**: cada anexo está abaixo do limite do seu tribunal? Os limites variam, algo entre 1,5 MB e 20 MB, conforme tribunal, sistema e tipo de petição. Confira o valor no [diretório de limites por tribunal](/tribunais/). Deixe uma margem de segurança de uns 5%, porque 1 MB pode ser contado como 1.000.000 bytes ou como 1.048.576 bytes (o chamado MiB), e sistemas diferentes usam um ou outro.
...
Esta ferramenta e este guia não são oficiais nem vinculados a nenhum tribunal. As regras de cada sistema mudam, e o único jeito seguro é abrir cada anexo final, conferir o conteúdo, a ordem e a assinatura, e só então protocolar.
