...
Como os limites de tamanho variam entre cerca de 1,5 MB e 20 MB conforme tribunal, sistema e tipo de petição, confira o valor que se aplica a você no [diretório de limites por tribunal](/tribunais/).
...
É isso que o aviso "a assinatura seria invalidada" quer dizer. Se você seguir em frente, o resultado não terá mais uma assinatura válida. O carimbo visual pode continuar aparecendo na página; o que se perde é a verificação eletrônica.
...
3. Deixe uma margem de segurança de uns 5% abaixo do limite. Alguns sistemas contam 1 MB como 1.000.000 bytes e outros como 1.048.576 bytes (o chamado MiB), e essa diferença pode derrubar um arquivo que está no limite exato.
